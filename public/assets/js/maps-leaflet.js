...
(function () {
  ...
  if (dragMapVar) {
    const draggableMap = L.map('dragMap').setView([-6.240490, 106.7972272], 12);
    const markerLocation = L.marker([-6.240490, 106.7972272], {
      // draggable: 'true'
    }).addTo(draggableMap);
    // markerLocation.bindPopup("<b></b>").openPopup();
    L.tileLayer('https://{s}.tile.osm.org/{z}/{x}/{y}.png', {
      attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
      maxZoom: 18
    }).addTo(draggableMap);
