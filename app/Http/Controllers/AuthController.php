    ...
    public function register(Request $request)
    {
        ...
        try {
            ...
            $this->validate($request, [
                ...
                'no_wa_2' => 'nullable|regex:/^\+?[0-9]+$/|unique:customers,no_wa|unique:users,nomor_telepon',
                'no_wa_3' => 'nullable|regex:/^\+?[0-9]+$/|unique:customers,no_wa|unique:users,nomor_telepon',
                'alamat' => 'required',
            ]);
