<div class="modal fade modal-bookmark" id="customerLimitKredit<?php echo e($data->id); ?>" tabindex="-1" role="dialog"
    aria-labelledby="modalCustomerLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content justify-content-start">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Limit Kredit</h5>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane contact-tab-0 tab-content-child fade show active" id="v-pills-user"
                            ...
                            <div class="profile-mail">
                                <form action="<?php echo e(route('customers.addCredit')); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
</div><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/project-expedisi/resources/views/customers/limit_kredit.blade.php ENDPATH**/ ?>