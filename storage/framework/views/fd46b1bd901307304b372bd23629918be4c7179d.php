                            ...
                            <div class="profile-mail">
                                <div class="email-general mb-2">
                                    ...
                                    <div class="row d-flex py-1 text-start justify-content-start">
                                        ...
                                        <div class="col-2">:</div>
                                        <div class="col-4"><?php echo e($data->kategori); ?></div>
                                    </div>
                                    <div class="row d-flex py-1 text-start justify-content-start">
                                        <div class="col-6">Modal</div>
                                        <div class="col-2">:</div>
                                        <div class="col-4"><?php echo e($data->modal); ?></div>
                                    </div>
                                    <div class="row d-flex py-1 text-start justify-content-start">
...
</div><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/project-expedisi/resources/views/data-pemasukan/detail.blade.php ENDPATH**/ ?>