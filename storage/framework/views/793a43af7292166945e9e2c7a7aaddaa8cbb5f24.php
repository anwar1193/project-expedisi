...
unset($__errorArgs, $__bag); ?>" type="text" name="modal" autocomplete="off" value="<?php echo e(old('modal', $datas->modal)); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="jumlah_pemasukkan" autocomplete="off" value="<?php echo e(old('jumlah_pemasukkan', $datas->jumlah_pemasukkan)); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
