			...
			<div class="d-flex justify-content-end">
                ...
                <div id="periode" class="px-2" style="display: <?php echo e($filter == 'periode' ? 'block' : 'none'); ?>">
                    <select name="periode" class="form-control">
                        ...
                        <option id="rangeOption" value="">Range Tanggal</option>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/project-expedisi/resources/views/laporan/laba-rugi.blade.php ENDPATH**/ ?>