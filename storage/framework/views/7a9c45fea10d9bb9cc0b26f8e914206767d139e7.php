...
unset($__errorArgs, $__bag); ?>" type="text" name="nomor_hp" autocomplete="off" value="<?php echo e(old('nomor_hp', $datas->nomor_hp)); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
							...
							<div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<textarea name="note" id="note" class="form-control"><?php echo e($datas->note); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/project-expedisi/resources/views/supplier/edit.blade.php ENDPATH**/ ?>