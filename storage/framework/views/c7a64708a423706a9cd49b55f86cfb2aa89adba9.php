		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" method="POST" action="<?php echo e(route('users.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
						<div class="card-body">
...
unset($__errorArgs, $__bag); ?>" type="text" name="kode_satker" autocomplete="off" value="<?php echo e(old('kode_satker')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="nama_satker" autocomplete="off" value="<?php echo e(old('nama_satker')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="nip" autocomplete="off" value="<?php echo e(old('nip')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="username" autocomplete="off" value="<?php echo e(old('username')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" type="email" name="email" autocomplete="off" value="<?php echo e(old('email')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" type="text" name="nomor_telepon" autocomplete="off" value="<?php echo e(old('nomor_telepon')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="password" autocomplete="off" value="<?php echo e(old('password')); ?>"/>
							...
							<div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<input name="password_confirmation" class="form-control <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/frontend/resources/views/admin/master/users/create.blade.php ENDPATH**/ ?>