	                                ...
	                                <div class="col-sm-6">
	                                    <div class="media">
	                                        <div class="media-left">
	                                            <a href="<?php echo e(route('index')); ?>"><img class="media-object img-60" src="<?php echo e(asset('assets/lion.jpg')); ?>" alt="Lion Parcel" /></a>
	                                        </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/project-expedisi/resources/views/invoice/index.blade.php ENDPATH**/ ?>