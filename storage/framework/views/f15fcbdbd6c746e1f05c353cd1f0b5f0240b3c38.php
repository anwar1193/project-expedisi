...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/logo-kejaksaan.png')); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo e(asset('assets/logo-kejaksaan.png')); ?>" type="image/x-icon">
  ...
  <body class="<?php echo e(Session::get('tema')); ?>-only">
    <!-- Loader starts-->
...
</html><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/frontend/resources/views/layouts/admin/master.blade.php ENDPATH**/ ?>