...
unset($__errorArgs, $__bag); ?>" type="text" name="pengguna_terkait" autocomplete="off" value="<?php echo e(old('pengguna_terkait', $datas->pengguna_terkait)); ?>"/>
...
unset($__errorArgs, $__bag); ?>">
											<option value="operasional" <?php echo e($datas->jenis_pengeluaran == 'operasional' ? 'selected' : NULL); ?>>Operasional</option>
											<option value="pengeluaran lain" <?php echo e($datas->jenis_pengeluaran == 'pengeluaran lain' ? 'selected' : NULL); ?>>Pengeluaran Lain</option>
										</select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/frontend/resources/views/daftar-pengeluaran/edit.blade.php ENDPATH**/ ?>