<?php $__env->startSection('title'); ?>Tambah OBD
<?php echo e($title); ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <form class="form theme-form" method="POST" action="<?php echo e(route('obd.store')); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                        name="merk" autocomplete="off" value="<?php echo e(old('merk')); ?>" />
...
unset($__errorArgs, $__bag); ?>" type="text"
                                        name="type" autocomplete="off" value="<?php echo e(old('type')); ?>" />
...
unset($__errorArgs, $__bag); ?>" type="text"
                                        name="serial_number" autocomplete="off" value="<?php echo e(old('serial_number')); ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/apps/paket1/frontend/resources/views/obd/create.blade.php ENDPATH**/ ?>