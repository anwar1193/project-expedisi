                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane contact-tab-0 tab-content-child fade show active" id="v-pills-user"
                            ...
                            <div class="profile-mail">
                                <form action="<?php echo e(route('posisi-cash.pemasukan')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="email-general mb-2">
                                        <div class="row d-flex py-1 text-start justify-content-start">
                                            ...
                                            <div class="col-1">:</div>
                                            <div class="col-6">
                                                <input id="pemasukan" type="text" class="form-control" value="<?php echo e(old('jumlah')); ?>" name="jumlah" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
                                            </div>
                                        </div>
...
</div><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/project-expedisi/resources/views/posisi-cash/pemasukan.blade.php ENDPATH**/ ?>