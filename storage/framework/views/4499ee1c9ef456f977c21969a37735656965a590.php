...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/kejaksaan.png')); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo e(asset('assets/kejaksaan.png')); ?>" type="image/x-icon">
