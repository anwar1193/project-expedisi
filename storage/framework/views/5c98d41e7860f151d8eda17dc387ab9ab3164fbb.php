...
<html lang="en">
  <head>
    ...
    <title>Bukti Terima <?php echo e($title); ?></title>
                ...
                <table>
                    ...
                    <tbody>
                        <tr style="font-weight: bold; border-bottom: 1px solid">
                            ...
                            <td style="text-align: center; text-decoration: underline">POCIPTO HALIM</td>
                        </tr>
                        <tr>
                            <td style="padding: 10px;">Uang Sejumlah</td>
                            <td style="padding: 10px;">:</td>
                            <td style="padding: 10px;">TUJUH PULIH LIMA RIBU RUPIAH</td>
                        </tr>
                        <tr>
                            <td style="padding: 10px;">Uang Pembayaran</td>
                            <td style="padding: 10px;">:</td>
                            <td style="padding: 10px;">Biaya Packing Kayu Resi No 11LP1699524802513</td>
                        </tr>
                        <tr>
                            <td style="padding: 10px;">Terbilang</td>
                            <td style="padding: 10px;">:</td>
                            <td style="font-weight: bold; padding: 10px;">Rp.75.000-</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div style="margin-top: -10px">
                <table>
                    <tbody>
                        <tr>
                            <td width="30%"></td>
                            <td style="padding-left: 10px">Jakarta, 30 Mei 2024</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
</html><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/frontend/resources/views/invoice/bukti-terima-pdf.blade.php ENDPATH**/ ?>