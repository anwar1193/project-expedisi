			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header pb-0">
						<h5>Form Tambah Perangkat</h5>
					</div>
					<form class="form theme-form" method="POST" action="<?php echo e(route('perangkat.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
						<div class="card-body">
...
unset($__errorArgs, $__bag); ?>" type="text" name="kode_perangkat" autocomplete="off" value="<?php echo e(old('kode_perangkat')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="nama_perangkat" autocomplete="off" value="<?php echo e(old('nama_perangkat')); ?>"/>
...
unset($__errorArgs, $__bag); ?>">
											...
											<?php $__currentLoopData = $jenis_perangkat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($data->kode_jenis); ?>"><?php echo e($data->jenis); ?></option>
...
unset($__errorArgs, $__bag); ?>" type="text" name="serial_number" autocomplete="off" value="<?php echo e(old('serial_number')); ?>"/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/apps/paket1/frontend/resources/views/perangkat/create.blade.php ENDPATH**/ ?>