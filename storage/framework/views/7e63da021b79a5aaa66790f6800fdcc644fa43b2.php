		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" method="POST" action="<?php echo e(route('data-barang.update', $data->id)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
						<div class="card-body">
...
unset($__errorArgs, $__bag); ?>" type="text" name="nama_barang" autocomplete="off" value="<?php echo e(old('nama_barang', $data->nama_barang)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="number" name="harga_beli" autocomplete="off" value="<?php echo e(old('harga_beli', $data->harga_beli)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="number" name="harga_jual" autocomplete="off" value="<?php echo e(old('harga_jual', $data->harga_jual)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="number" name="stok" autocomplete="off" value="<?php echo e(old('stok', $data->stok)); ?>"/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/frontend/resources/views/data-barang/edit.blade.php ENDPATH**/ ?>