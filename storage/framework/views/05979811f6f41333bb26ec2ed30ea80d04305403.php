...
unset($__errorArgs, $__bag); ?>" id="no_wa" placeholder="Contoh: 08xxxxxxxx" type="text" name="no_wa_2" value="<?php echo e(old('no_wa', $customer->no_wa_2)); ?>" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
...
unset($__errorArgs, $__bag); ?>" id="no_wa" placeholder="Contoh: 08xxxxxxxx" type="text" name="no_wa_3" value="<?php echo e(old('no_wa', $customer->no_wa_3)); ?>" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
