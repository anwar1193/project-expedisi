...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('data-pengiriman.download-resi')); ?>" class="btn btn-warning">Download Data Resi</a>
                    <button class="btn btn-primary text-white" type="submit">Update</button>
                </div>
            </form>
        </div>
    </div>
</div><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/project-expedisi/resources/views/data-pengiriman/modal-status-pengiriman.blade.php ENDPATH**/ ?>