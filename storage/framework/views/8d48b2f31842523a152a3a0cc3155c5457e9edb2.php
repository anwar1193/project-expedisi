														...
														<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
															...
															<?php if(isAdmin()): ?>
																<?php if($data->status == true): ?>
																	<a class="dropdown-item" href="<?php echo e(route('customers.non-aktif', $data->id)); ?>" onclick="return confirm('Menonaktifkan Customer Ini?')"><span><i data-feather="check-square"></i> Nonaktifkan</span></a>
																<?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/munawarahmad/Documents/Applications/projectku/project-expedisi/resources/views/customers/index.blade.php ENDPATH**/ ?>