...
@section('title')Tambah Jenis Perangkat
 {{ $title }}
@endsection
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" method="POST" action="{{ route('jenis-perangkat.store') }}" enctype="multipart/form-data">
                        @csrf
						<div class="card-body">
							...
							<div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<input class="form-control @error('kode_jenis') is-invalid @enderror" type="text" name="kode_jenis" autocomplete="off" value="{{ old('kode_jenis') }}"/>
                            ...
                            <div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<input class="form-control @error('jenis') is-invalid @enderror" type="text" name="jenis" autocomplete="off" value="{{ old('jenis') }}"/>
