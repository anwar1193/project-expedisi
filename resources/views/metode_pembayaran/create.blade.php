		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" method="POST" action="{{ route('metode_pembayaran.store') }}" enctype="multipart/form-data">
                        @csrf
						<div class="card-body">
							...
							<div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<input class="form-control @error('metode') is-invalid @enderror" type="text" name="metode" autocomplete="off" value="{{ old('metode') }}"/>
								...
								<div class="col">
									<div class="mb-3">
										...
										<div class="radio radio-primary">
											<input id="wajibBukti1" type="radio" name="wajib_bukti" value="1">
											<label for="wajibBukti1">Ya</label>
										  </div>
										  <div class="radio radio-primary">
											<input id="wajibBukti2" type="radio" name="wajib_bukti" value="0" checked>
