		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<form class="form theme-form" method="POST" action="{{ route('perangkat.store') }}" enctype="multipart/form-data">
                        @csrf
						<div class="card-body">
							...
							<div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<input class="form-control @error('kode_perangkat') is-invalid @enderror" type="text" name="kode_perangkat" autocomplete="off" value="{{ old('kode_perangkat') }}"/>
							...
							<div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<input class="form-control @error('nama_perangkat') is-invalid @enderror" type="text" name="nama_perangkat" autocomplete="off" value="{{ old('nama_perangkat') }}"/>
									...
									<div class="mb-3">
										...
										<select name="jenis_perangkat" id="jenis_perangkat" class="form-control @error('jenis_perangkat') is-invalid @enderror">
											...
											@foreach ($jenis_perangkat as $data)
												<option value="{{ $data->kode_jenis }}">{{ $data->jenis }}</option>
											@endforeach
										</select>
							...
							<div class="row">
								<div class="col">
									<div class="mb-3">
										...
										<input class="form-control @error('serial_number') is-invalid @enderror" type="text" name="serial_number" autocomplete="off" value="{{ old('serial_number') }}"/>
