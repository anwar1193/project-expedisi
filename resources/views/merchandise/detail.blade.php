<div class="modal fade modal-bookmark" id="modalMerchandise{{ $data->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="profile-mail">
                                <div class="email-general mb-2">
                                    <div class="row d-flex py-1 text-start justify-content-start">
                                        ...
                                        <div class="col-2">:</div>
                                        <div class="col-4 text-capitalize">{{ $data->nama }}</div>
                                    </div>
                                    <div class="row d-flex py-1 text-start justify-content-start">
                                        <div class="col-6">Nilai</div>
                                        <div class="col-2">:</div>
                                        <div class="col-4">{{ number_format($data->nilai, 0, '.', ',') }}</div>
                                    </div>
                                    <div class="row d-flex py-1 text-start justify-content-start">
