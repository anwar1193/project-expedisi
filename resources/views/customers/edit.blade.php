						...
						<div class="card-body">
							...
							<div class="row g-3 py-2">
								...
								<div class="col-md-6">
									...
									<input class="form-control @error('no_wa_3') is-invalid @enderror" id="no_wa" placeholder="Contoh: 08xxxxxxxx" type="text" name="no_wa_3" value="{{ old('no_wa', $customer->no_wa_3) }}" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
