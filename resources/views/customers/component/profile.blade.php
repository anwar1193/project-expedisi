            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="profile-title">
                        <div class="media">
                            <img class="img-90" alt="" src="{{ asset('storage/foto_profil/'.$data->foto) }}" />
                            <div class="media-body" style="margin-left:15px">
                                <h3 class="mb-1 f-20 txt-danger">{{ $data->nama }}</h3>
                                <p class="f-12">{{ $data->nama_level }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="user_level" value="{{ $data->nama_level }}" readonly/>
                        </div>
                    </div>
