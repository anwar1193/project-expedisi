...
<div class="container-fluid dashboard-default-sec">
          ...
          <div class="d-flex flex-column col-12" role="search">
              <div class="d-flex flex-row">
                ...
                @if((request()->has('tahun')) && (request('tahun') != date('Y')))
                  <a href="{{ route('dashboard.customer') }}" class="btn btn-md btn-warning"><i class="fa fa-refresh" title="Pencarian Ulang"></i></a>
                @endif 
              </div>
          </div>
        </div>
  ...
  <div class="row">
    ...
    <div class="col-xl-4 col-md-4 col-sm-4 box-col-4 des-xl-25 rate-sec">
      <a href="{{ route("invoice-customer") }}">
        <div class="card income-card card-primary">
          <div class="card-body text-center">
            <p class="fs-6">Invoice</p>
            <h5><i class="icofont icofont-ui-note"></i>  {{ $invoice }}</h5>
            <div class="parrten">
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                y="0px" viewbox="0 0 448.057 448.057" style="enable-background:new 0 0 448.057 448.057;"
                xml:space="preserve">
  ...
  <script>
    ...
    var options55 = {
      series: [{
          name: "Jumlah Transaksi Pengiriman",
          data: data
      }],
      chart: {
          height: 250,
    ...
    $(document).ready(function() {
        $('#tahun').change(function(event) {
            ...
            window.location.href = "{{ route('dashboard.customer') }}?tahun=" + selectedYear;
        });
    });
