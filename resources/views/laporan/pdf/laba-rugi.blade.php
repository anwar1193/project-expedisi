...
<head>
    ...
    <title>Laporan Laba/Rugi {{ $title }}</title>
...
<body>
    ...
    <div class="row">
        <div class="col">
            <h5>Periode: {{ \Carbon\Carbon::parse($start)->translatedFormat('d F Y') }} s/d {{ \Carbon\Carbon::parse($end_date)->translatedFormat('d F Y') }}  </h5>
            <div class="row">
