                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane contact-tab-0 tab-content-child fade show active" id="v-pills-user"
                            ...
                            <div class="profile-mail">
                                <form action="{{ route('posisi-cash.pengeluaran') }}" method="post">
                                @csrf
                                <div class="email-general mb-2">
                                        <div class="row d-flex py-1 text-start justify-content-start">
                                            ...
                                            <div class="col-1">:</div>
                                            <div class="col-6">
                                                <input id="pengeluaran" type="text" class="form-control" value="{{ old('jumlah') }}" name="jumlah" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
                                            </div>
                                        </div>
