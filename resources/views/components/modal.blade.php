...
<div class="modal fade modal-bookmark" id="exampleModal{{ $item->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="profile-mail">
                                <div class="media d-flex justify-content-center">
                                    <img class="img-fluid rounded m-r-20 update_img_0"
                                        src="{{ asset('storage/surveilance-car/'.$item->foto) }}"
                                        alt="{{$item->merk}}" width="200px"/>
                                </div>
                                <div class="email-general mt-3">
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-4">Merk</div>
                                        <div class="col-2">:</div>
                                        <div class="col-4">{{ $item->merk }}</div>
                                    </div>
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-4">Nomor Polisi</div>
                                        <div class="col-2">:</div>
                                        <div class="col-4">{{ $item->nopol }}</div>
                                    </div>
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-4">Warna</div>
                                        <div class="col-2">:</div>
                                        <div class="col-4">{{ $item->warna }}</div>
                                    </div>
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-4">Kapasitas</div>
                                        <div class="col-2">:</div>
                                        <div class="col-4">{{ $item->kapasitas }}</div>
                                    </div>
                                    <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        ...
                                        <div class="col-2">:</div>
                                        <div class="col-4">{{ $item->kondisi }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
