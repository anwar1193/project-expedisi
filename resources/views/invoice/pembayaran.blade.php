<div class="modal fade modal-bookmark" id="pembayaranInvoice{{ $data->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="profile-mail">
                                ...
                                <div class="email-general mb-2">
                                        ...
                                        <div class="row d-flex py-1 text-start justify-content-start">
                                            ...
                                            <div class="col-1">:</div>
                                            <div class="col-6">Rp {{ number_format($data->totalBersih, 0, '.', '.') }}</div>
                                            <input type="hidden" style="display: none" class="form-control" value="{{ $data->totalBersih }}" name="total_tagihan">
                                        </div>
